...
let toppingsOrder = prompt ('What kind of toppings would you like? (Seperate multiple toppings with a comma.)');


let condimentsOrder = prompt ('What kind of condiments would you like? (Seperate multiple condiments with a comma.)');
